...
import { createJobPortalEntry } from "../../../../services/JobPortalService";
  ...
  return (
    <>
      <div className="d-flex align-items-center mb-4 flex-wrap">
        <h3 className="mb-0 me-auto">Seeker Job-View</h3>
        {/* <div>
                ...
                <div className="card-footer border-0 pt-0 ">
                  <div className="d-flex justify-content-between flex-wrap">
                    {/* <Link to={"#"} className="btn btn-primary btn-sm mb-3">
                      <i className="fas fa-check me-2 "></i>Apply Now
                    </Link> */}
                    <button onClick={handleApply} className="btn btn-primary btn-sm mb-3">
                      <i className="fas fa-check me-2"></i>Apply Now
                    </button>
                    ...
                    >
                      <i className="fas fa-phone-volume me-2"></i>Contact Now
                    </Link>
                  </div>
                </div>
              </div>
              ...
              <div className="card">
                <div className="card-header d-block">
                  ...
                  <div className="d-block">
                    ...
                    {/* <span>
                      <Link to={"#"}>
                        <i className="text-primary fas fa-eye me-2"></i>View
                      </Link>
                    </span> */}
                  </div>
                </div>
                <div className="card-body pb-0">
                  ...
                  <div className="ms-2">
                    ...
                    {/* <p>
                      <i className="text-primary fas fa-dot-circle me-2 "></i>
                      Good knowledge of SQL and related databases, with a
                      preference for those with MySQL experience.
                    </p>
                    <p>
                      <i className="text-primary fas fa-dot-circle me-2 "></i>
                      Excellent knowledge of the basic PHP 7 or web server
                      exploits along with their solutions.
                    </p>
                    <p>
                      <i className="text-primary fas fa-dot-circle me-2 "></i>
                    ...
                    <p>
                      <i className="text-primary fas fa-dot-circle me-2 "></i>A
                      detailed understanding of database design and
                      administration.
                    </p>
                    <p>
                      <i className="text-primary fas fa-dot-circle me-2 "></i>
                      The ability to integrate a variety of data sources and
                      databases into a single system.
                    </p> */}
                  </div>
                  <hr />
                ...
                <div className="card-footer border-0">
                  <div>
                    <Link to={"#"} className="btn btn-primary btn-sm me-2 mb-3">
                      <i className="far fa-check-circle me-2"></i>Apply
                    </Link>
